...
function question(str) {
    ...
    function splitJoinFunction(string){
    ...
    newStr = splitJoinFunction(newStr);
    newStrReverse = newStr.split("").reverse().join("");

    str = splitJoinFunction(str);
    strReverse = str.split("").join("");

    returnResult();
    
    function returnResult(){
        if(strReverse===newStrReverse){
            result = true;
        }else{
            result = false;
        }
